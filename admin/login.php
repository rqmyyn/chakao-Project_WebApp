...
if (isset($_SESSION['username'])) {
    ...
    header('Location: pages/admin_dashboard.php'); // หรือไปยังหน้าที่คุณต้องการ
    exit();
    ...
    if ($result->num_rows > 0) {
        ...
        header('Location: pages/admin_dashboard.php'); // ให้พนักงานไปยังหน้า dashboard ของพนักงาน
        exit();
    } else {
        include('../component/pop-up/user-not-found.html');
    }
...
<body>
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <h1><i class="fas fa-store fa-1x text-primary "></i> ระบบการจัดการร้าน</h1>
                <div class="card">
                    <div class="card-header">ล็อกอินแอดมิน</div>
                    <div class="card-body">
                        <form method="POST">
